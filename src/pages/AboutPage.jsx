...
function AboutPage() {
  ...
  return (
    <main className="container">
      ...
      <p>
        <Trans i18nKey="aboutPage_text4" >Udemy course:<a href="https://www.udemy.com/course/react-js-inicia-en-el-mundo-de-los-frameworks-de-javascript/" target="_blank"/></Trans><br/>
      </p>
      <p>{t("aboutPage_text5")}</p>
